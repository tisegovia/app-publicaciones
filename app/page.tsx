...
export default function Home() {
  ...
  function handleImageSelected(base64: string, mime: string, preview: string) {
  ...
  async function handleGenerate() {
    ...
    try {
      const res = await fetch("/api/generate", {
        ...
        body: JSON.stringify({ imageBase64, imageMimeType, platforms, condition, dollarType }),
      });
    ...
    <div className="max-w-2xl mx-auto">
      ...
      <div className="flex items-center gap-2 mb-8">
        {(["upload", "configure", "result"] as Step[]).map((s, i) => {
          const labels = ["Subir foto", "Configurar", "Resultados"];
      ...
      {step === "upload" && (
        <div>
          <h1 className="text-2xl font-bold text-gray-900 mb-2">Subí la foto del producto</h1>
          <p className="text-gray-500 mb-6">La IA analizará la imagen y detectará el producto automáticamente</p>
